...
- TLS support via `ssl_context:` keyword argument was advertised in v2.0.0 but was not included in the published gem due to a tagging error. [@petergoldstein](https://github.com/petergoldstein)
